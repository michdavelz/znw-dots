...
{ env | grep -Fq 'DISTROBOX' && PS1='$(ec=${?##0};echo ${ec:+[\[\033[91;05m\]${ec}\[\033[0m\]]})\[\033[0;1m\]\u\[\033[0m\]@\h\[\033[33m\] \[\033[0m\]:\W\$ '; } || PS1='$(ec=${?##0};echo ${ec:+[\[\033[91;05m\]${ec}\[\033[0m\]]})\[\033[0;1m\]\u\[\033[0m\]@\h\[\033[35m\]󰣨 \[\033[0m\]:\W\$ '
PS2=' '
